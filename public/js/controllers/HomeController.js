    ...
    function($scope, $firebaseObject, $firebaseArray) {
        ...
        $scope.auth.onAuthStateChanged(function(firebaseUser) {
            if (firebaseUser == null) {
                ...
                PointsObj = new $firebaseObject(DATABASE.child('Users').child($scope.currentUser.uid).child('Points'));
                ...
                // $scope.allowedHashtags = $firebaseArray(DATABASE.child('Hashtags'));
        ...
        $scope.addPost = function() {
            ...
            if (getPoint == null) {
                ...
                if (getPoint.length != 1) {
                    ...
                    if (PointsObj.current <= 0 || $scope.point > PointsObj.current) {
                        console.warn(TAG + 'insufficient points to give. ');
                        return alert(TAG + 'insufficient points to give. ');
                    }
                }
            }
